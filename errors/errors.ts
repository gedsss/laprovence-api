...
export class CompanyNotFoundError extends NotFoundError {
  constructor(identifier?: string) {
    super('Empresa', identifier)
    this.code = ErrorCodes.COMPANY_NOT_FOUND
  }
}

export class CompanyInactiveError extends AppError {
  constructor(companyId: string) {
    super(422, ErrorCodes.COMPANY_INACTIVE, 'A empresa está inativa', {
      companyId,
      code: ErrorCodes.COMPANY_INACTIVE,
    })
  }
}
